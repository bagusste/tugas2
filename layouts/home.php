...
<html lang="en">
  ...
  <body>
    <form action="<?php echo URL; ?>/user/login" method="post" class="container-sm w-50 border p-5 position-absolute top-50 start-50 translate-middle bg-dark bg-gradient text-center">
        <div class="container">
