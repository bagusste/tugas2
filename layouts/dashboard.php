...
<html lang="en" class="ms-5 me-5">
  ...
  <body>
    ...
    <div class="container-fluid w-100 border-start border-end border-bottom text-center py-4 align-middle" style="height:550px">
        <h1>Selamat Datang</h1>
        <p>Ini adalah Web Sistem Informasi PLN</p>
    </div>
